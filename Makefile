...
documentation:
	...
	docstr-coverage causal_data_augmentation --failunder=0 --skipmagic --exclude=".*/__init__.py" --skipfiledoc --badge ./docs_src/coverage_badge.svg  2>&1 | tee docs_src/docstr-coverage-output.txt
