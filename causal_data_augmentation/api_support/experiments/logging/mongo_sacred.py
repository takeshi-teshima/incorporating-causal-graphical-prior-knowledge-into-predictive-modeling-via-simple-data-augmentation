...
class MongoAndSacredRunLogger(RunLogger):
    ...
    def __init__(self,
        ...
        self.shared_pickle_dir = Path(shared_pickle_dir)
    ...
    def save_artifact(self, data: Any, name: str) -> None:
        ...
        pickler.save(data)
        self.set_tags({f'artifact_{name}': str(self.shared_pickle_dir / name)})
